...
accessKeyId = "LTAI5t7W3NLQieLHs4imcfvT"  # 将accessKeyId改成自己的accessKeyId
accessSecret = "tj3B6DaVW7Yndn4nw53PjkIjYXLF0H"  # 将accessSecret改成自己的accessSecret
domain = "wallfacer.xyz"  # 你的主域名
name_ipv4 = ""  # 要进行ipv4 ddns解析的子域名
name_ipv6 = "homepc"  # 要进行ipv6 ddns解析的子域名
